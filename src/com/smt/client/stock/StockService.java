 ...
 * servlet
 * "stock" will be included as a url pattern for the servlet in the web.xml file.
 * 
 * */
@RemoteServiceRelativePath("stock")
/*
 * Here we are taking the  StockService interface
...
public interface StockService extends RemoteService{
	StockDao checkStock(String reqId, String productName);
	void deleteStock(String productId);
	StockDao sortStock(String pname);
	StockDao viewStock();
	void insertStock(ArrayList<String> pid, ArrayList<String> pname, 
			ArrayList<String> pconfig, ArrayList<String> warranty);
}
